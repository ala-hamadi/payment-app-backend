...
public class ProductController {
  ...
  @PutMapping("/decreaseQuantityInProducts")
  public String decreaseQuantityInProducts(@RequestBody List<CartReq> cart) {
    return productService.decreaseQuantityInProducts(cart);
  }
  @PutMapping("/removeAllProductsFromCart/{user_id}")
  public Users removeAllProductsFromCart(@PathVariable(value = "user_id") int user_id) {
    return productService.removeAllProductsFromCart(user_id);
  }
}
